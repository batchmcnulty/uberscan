...
echo "on every box. Or it would if we let it run long enough - remember, just a demo. "
echo "The main thing is that it finds open Telnet ports... so you can close 'em!"
echo " "
echo "This is for demonstration purposes - There's another one that does the same thing using password files."
